...
var hocs = require('./hocs-018c38ad.js');
...
function (_React$PureComponent) {
  hocs._inherits(NaverMap, _React$PureComponent);

  function NaverMap(props) {
    var _this;

    hocs._classCallCheck(this, NaverMap);

    _this = hocs._possibleConstructorReturn(this, hocs._getPrototypeOf(NaverMap).call(this, props));
    _this.state = {};
    return _this;
  }

  hocs._createClass(NaverMap, [{
    ...
    value: function updateMapOptions() {
      ...
      this.setOptions(hocs._objectSpread({}, mapOptions));
    }
    /**
     * createMap
     *
    ...
    value: function render() {
      ...
      return React.createElement(hocs.MapContext.Provider, {
        value: this.map
...
var NaverMap$1 = recompose.compose(hocs.withNavermaps, hocs.bridgeEventHandlers, hocs.injectNaverRef)(NaverMap);
...
var Overlay$1 = recompose.compose(hocs.withMap, hocs.bridgeEventHandlers)(Overlay);
...
function Circle(props) {
  return React.createElement(Overlay$1, hocs._extends({}, props, {
...
/*#__PURE__*/
function (_React$PureComponent) {
  hocs._inherits(GroundOverlay, _React$PureComponent);
...
var GroundOverlay$1 = recompose.compose(hocs.withNavermaps, hocs.withMap, hocs.bridgeEventHandlers)(GroundOverlay);
